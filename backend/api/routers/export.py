...
async def export_hazards_api(
    status: str = None, hazard_type: str = None, urgency: str = None,
...
async def export_reports_api(
    report_type: str = None, r_status: str = Query(None, alias="status"),
    db: AsyncSession = Depends(get_db), current_user=Depends(get_current_user),
):
    """导出报告数据"""
...
async def export_risks_api(
    level: str = None, risk_status: str = Query(None, alias="status"),
    db: AsyncSession = Depends(get_db), current_user=Depends(get_current_user),
):
    """导出风险数据"""
...
async def export_contracts_api(
    contract_type: str = None, c_status: str = Query(None, alias="status"),
    db: AsyncSession = Depends(get_db), current_user=Depends(get_current_user),
):
    """导出合同数据"""
