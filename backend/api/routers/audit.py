...
ACTION_NAMES = {
    ...
    "update": "更新", "delete": "删除", "approve": "审批通过",
    "reject": "审批驳回", "submit": "提交", "return": "退回",
}

ENTITY_NAMES = {
    "user": "用户", "project": "项目", "hazard": "随手拍",
    "report": "报告", "approval": "审批流", "task": "任务",
}
...
def add_audit_log(
    db, user_id: str, username: str, action: str,
    entity_type: str, entity_id: str = None, entity_name: str = None,
