MY_MODELS_TEMPLATE = '''"""SQLAlchemy database models — generated from PRD."""
...
class Department(Base):
    ...
    leader_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class User(Base):
    ...
    hazard_reports: Mapped[list["HazardReport"]] = relationship(back_populates="reporter")
...
class Milestone(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    project_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("projects.id"), nullable=False)
    phase_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("phases.id"), nullable=True)
    name: Mapped[str] = mapped_column(String(200), nullable=False)
...
class Task(Base):
    ...
    parent_task_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("tasks.id"), nullable=True)
...
class HazardReport(Base):
    ...
    assigned_by_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), nullable=True)
    confirmed_by_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), nullable=True)
    ...
    reporter: Mapped["User"] = relationship(back_populates="hazard_reports", foreign_keys=[reporter_id])
...
class HazardTransfer(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    hazard_report_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("hazard_reports.id"), nullable=False)
...
class HazardRectification(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    hazard_report_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("hazard_reports.id"), nullable=False)
    handler_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), nullable=False)  # 整改责任人
    dept_admin_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), nullable=False)  # 兼职安全环保管理员（接收下推的人）
    due_date: Mapped[datetime] = mapped_column(DateTime, nullable=False)
    ...
    accepted_by_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), nullable=True)
...
class RectificationPhoto(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    rectification_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("hazard_rectifications.id"), nullable=False)
...
class InspectionPoint(Base):
    ...
    project: Mapped["Project"] = relationship(back_populates="inspection_points")
...
class Inspection(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    point_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("inspection_points.id"), nullable=False)
    project_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("projects.id"), nullable=False)
