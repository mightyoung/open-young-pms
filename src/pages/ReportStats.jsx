...
export default function ReportStats() {
  ...
  const statsData = [
    { label: '报告总数', value: summary.total || 0, icon: <FileTextOutlined />, color: colors.accent },
    { label: '已通过', value: summary.approved || 0, icon: <CheckCircleOutlined />, color: colors.success },
    { label: '已驳回', value: summary.rejected || 0, icon: <ClockCircleOutlined />, color: colors.danger },
            ...
            {typeData.length > 0 ? (
              <ResponsiveContainer width="100%" height={120}>
                <BarChart data={typeData}>
                  ...
                  <Tooltip contentStyle={{ background: colors.bg.card, border: colors.bg.elevated, color: colors.text.primary }} />
