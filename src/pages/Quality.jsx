...
const MOCK_STANDARDS = [
  {
    ...
    status: 'active',
    items: 15,
    desc: '适用于所有钢构件焊接施工的质量验收，涵盖焊缝外观、尺寸、无损检测要求。',
  },
  {
    id: 2,
    code: 'STD-ELC-001',
  ...
  },
  {
    ...
    status: 'active',
    items: 18,
    desc: '工业管道安装施工及验收规范，含材质、焊接、试压要求。',
  },
  {
    id: 4,
    code: 'STD-STR-002',
    ...
    status: 'inactive',
    items: 12,
    desc: '混凝土结构施工质量控制标准，含配合比、养护、强度要求。',
  },
]
...
export default function Quality() {
  ...
  const stats = {
    ...
    pending: MOCK_INSPECTIONS.filter(i => i.result === 'pending').length,
  }
    ...
    <div>
      ...
      <Row gutter={[12, 12]} style={{ marginBottom: 20 }}>
        {[
          {
            title: '检查标准',
            value: MOCK_STANDARDS.filter(s => s.status === 'active').length,
            color: D.primary,
          },
