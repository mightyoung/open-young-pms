...
const COLORS = [colors.danger, colors.warning, colors.warning, colors.success, colors.accent, '#8b5cf6']
...
export default function HazardStats() {
  ...
  const summaryData = [
    { label: '隐患总数', value: summary.total_hazards || 0, icon: <AlertOutlined />, color: colors.danger },
    { label: '待处理', value: summary.pending_hazards || 0, icon: <ClockCircleOutlined />, color: colors.warning },
