...
const MOCK_REPORTS = [
  ...
  {
    id: 3,
    title: 'XX集团设备安装工程 - 第12周周报',
    type: 'weekly',
    project: 'XX集团设备安装工程',
    author: '王经理',
    submitTime: '2026-03-28 16:30',
    status: 'pending',
    progress: 62,
    issues: 3,
    milestone: '设备安装中',
  ...
  {
    id: 6,
    title: '产线自动化改造项目 - 第11周周报',
    type: 'weekly',
    project: '产线自动化改造项目',
    author: '张经理',
    submitTime: '2026-03-21 17:00',
    status: 'approved',
    progress: 75,
    issues: 2,
    milestone: '方案评审',
      ...
      <Card style={{ borderRadius: 12 }}>
        <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between' }}>
          ...
          <Space>
            ...
            <Button type="primary" icon={<Plus size={14} />} onClick={() => setModalVisible(true)}>
              新建报告
            </Button>
          </Space>
        </div>
      ...
      >
        <Form layout="vertical" style={{ marginTop: 20 }}>
          ...
          <Form.Item
            label="问题与风险"
            name="issues"
            rules={[{ required: true, message: '请填写问题与风险' }]}
          >
            <textarea
              style={{
                width: '100%',
              ...
              placeholder="描述本周遇到的问题..."
            />
          </Form.Item>
          <Form.Item
            label="里程碑进展"
            name="milestone"
            rules={[{ required: true, message: '请填写里程碑进展' }]}
          >
            <textarea
              style={{
                width: '100%',
        ...
        {previewReport && (
          <div>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <Tag
                color={
                  previewReport.issues > 3 ? 'red' : previewReport.issues > 0 ? 'orange' : 'green'
                }
              >
